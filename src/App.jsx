...
const translations = {
  el: {
    ...
    aboutMeText: "Προπτυχιακή φοιτήτρια Μηχανικών Πληροφορικής με ευρύ ενδιαφέρον για όλο το φάσμα του προγραμματισμού και πάθος για τη διαρκή εκμάθηση νέων τεχνολογιών. Αν και με συναρπάζει η επίλυση προβλημάτων σε κάθε επίπεδο του software engineering, αυτή τη στιγμή εστιάζω στο Full-Stack Development. Στόχος μου είναι να συνδυάζω τις ισχυρές βάσεις μου σε αλγορίθμους και συστήματα με τη δημιουργία σύγχρονων, λειτουργικών και ολοκληρωμένων web εφαρμογών.",
    downloadCv: "Λήψη CV",
